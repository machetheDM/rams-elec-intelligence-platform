...
/**
 * Admin analytics overview — Recharts dashboard page.
 *
 * One of 7 analytics pages (overview, inquiries, revenue, equipment,
 * technicians, load-shedding, follow-ups) that replaced the original
 * Streamlit dashboard. All data fetching goes through same-origin proxy
 * routes — the browser never sees an API key.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* Technician Utilisation — Recharts Bar */}
        <div className="bg-industrial-900 rounded-xl border border-industrial-800 p-6">
